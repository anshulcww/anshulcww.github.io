app.controller('SingleCtrl', ['$state', '$timeout', '$scope', '$http', '$stateParams', '$cookies', 'ionicMaterialInk', 'loginService', function ($state, $timeout, $scope, $http, $stateParams, $cookies, ionicMaterialInk, loginService) {
    ...
    $scope.saveEvent = function(){
       // var str = "620.0-256-B43A7BE26807";
        console.log($scope.eventNote);
        ...
        $http({
              ...
              headers: {'Content-Type': 'application/x-www-form-urlencoded'}
                ...
                if(data.result){
                    ...
                    $scope.success = false;
                    $scope.failure = true;
                    alert('Event could not be logged');
                }
